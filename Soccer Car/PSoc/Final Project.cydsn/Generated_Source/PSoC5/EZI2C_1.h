...
#define EZI2C_1_ONE_ADDRESS    (1u)
#define EZI2C_1_TWO_ADDRESSES  (2u)

/* Sub-address size enum. */
#define EZI2C_1_ANY   (0u)
#define EZI2C_1_I2C0  (1u)
#define EZI2C_1_I2C1  (2u)

/* Sub-address size enum. */
#define EZI2C_1_SUBADDR_8BIT   (0u)
#define EZI2C_1_SUBADDR_16BIT  (1u)
...
#define EZI2C_1_SetPendingInt()    CyIntSetPending  (EZI2C_1_ISR_NUMBER)
...
void    EZI2C_1_SetBuffer1(uint16 bufSize, uint16 rwBoundary, volatile uint8 * dataPtr) ;
void    EZI2C_1_SetAddress1(uint8 address) ;
uint8   EZI2C_1_GetAddress1(void)          ;

#if (EZI2C_1_ADDRESSES == EZI2C_1_TWO_ADDRESSES)
    void    EZI2C_1_SetBuffer2(uint16 bufSize, uint16 rwBoundary, volatile uint8 * dataPtr) ;
...
#define EZI2C_1_IS_BIT_SET(value, mask) (((mask) == ((value) & (mask))) ? (1u) : (0u))
...
#define EZI2C_1_ACT_PWR_EN     ( (uint8)  EZI2C_1_I2C_Prim__PM_ACT_MSK)
...
#define EZI2C_1_STBY_PWR_EN        ( (uint8)  EZI2C_1_I2C_Prim__PM_STBY_MSK)
...
#define EZI2C_1_CLEAR_REG          (0x00u)
#define EZI2C_1_BLOCK_RESET_DELAY  (2u)

/* XCFG I2C Extended Configuration Register */
#define EZI2C_1_XCFG_CLK_EN        (0x80u) /* Clock enable */
#define EZI2C_1_XCFG_I2C_ON        (0x40u) /* Set before entering sleep mode */
#define EZI2C_1_XCFG_SLEEP_READY   (0x20u) /* Ready to sleep */
#define EZI2C_1_XCFG_FORCE_NACK    (0x10u) /* Force nack */
#define EZI2C_1_XCFG_HDWR_ADDR_EN  (0x01u) /* Hardware address comparison */
...
#define EZI2C_1_CFG_SIO_SELECT    (0x80u) /* Pin Select for SCL/SDA lines */
#define EZI2C_1_CFG_PSELECT       (0x40u) /* Pin Select */
#define EZI2C_1_CFG_BUS_ERR_IE    (0x20u) /* Bus Error Interrupt Enable */
#define EZI2C_1_CFG_STOP_ERR_IE   (0x10u) /* Enable Interrupt on STOP condition */
#define EZI2C_1_CFG_STOP_IE       (0x10u) /* Enable Interrupt on STOP condition */
#define EZI2C_1_CFG_CLK_RATE      (0x04u) /* Clock rate mask. 1 for 50K, 0 for 100K and 400K */
#define EZI2C_1_CFG_EN_SLAVE      (0x01u) /* Enable Slave operation */

/* CSR I2C Control and Status Register */
#define EZI2C_1_CSR_BUS_ERROR     (0x80u) /* Active high when bus error has occurred */
#define EZI2C_1_CSR_LOST_ARB      (0x40u) /* Set to 1 if lost arbitration in host mode */
#define EZI2C_1_CSR_STOP_STATUS   (0x20u) /* Set to 1 if Stop has been detected */
#define EZI2C_1_CSR_ACK           (0x10u) /* ACK response */
#define EZI2C_1_CSR_NAK           (0x00u) /* NAK response */
#define EZI2C_1_CSR_LRB_ACK       (0x00u) /* Last received bit was an ACK */
#define EZI2C_1_CSR_ADDRESS       (0x08u) /* Set in firmware 0 = status bit, 1 Address is slave */
#define EZI2C_1_CSR_TRANSMIT      (0x04u) /* Set in firmware 1 = transmit, 0 = receive */
#define EZI2C_1_CSR_LRB           (0x02u) /* Last received bit */
#define EZI2C_1_CSR_LRB_NAK       (0x02u) /* Last received bit was an NAK */
#define EZI2C_1_CSR_BYTE_COMPLETE (0x01u) /* Informs that last byte has been sent */

/* I2C state machine constants */
#define  EZI2C_1_SM_IDLE              (0x00u) /* Wait for Start */

/* Primary slave address states */
#define  EZI2C_1_SM_DEV1_WR_ADDR      (0x01u) /* Wait for sub-address */
#define  EZI2C_1_SM_DEV1_WR_ADDR_MSB  (0x01u) /* Wait for sub-address MSB */
#define  EZI2C_1_SM_DEV1_WR_ADDR_LSB  (0x02u) /* Wait for sub-address LSB */
#define  EZI2C_1_SM_DEV1_WR_DATA      (0x04u) /* Get data from Master */
#define  EZI2C_1_SM_DEV1_RD_DATA      (0x08u) /* Send data to Master */

/* Secondary slave address states */
#define  EZI2C_1_SM_DEV2_WR_ADDR      (0x11u) /* Wait for sub-address */
#define  EZI2C_1_SM_DEV2_WR_ADDR_MSB  (0x11u) /* Wait for sub-address MSB */
#define  EZI2C_1_SM_DEV2_WR_ADDR_LSB  (0x12u) /* Wait for sub-address LSB */
#define  EZI2C_1_SM_DEV2_WR_DATA      (0x14u) /* Get data from Master */
#define  EZI2C_1_SM_DEV2_RD_DATA      (0x18u) /* Send data to Master */
...
#define EZI2C_1_OVS_32_LIM      (50u)
#define EZI2C_1_OVERSAMPLE_RATE ((EZI2C_1_DATA_RATE <= EZI2C_1_OVS_32_LIM) ? (32u) : (16u))

/* Return default bits depends on configuration */
#define EZI2C_1_DEFAULT_HDWR_ADDR  ((EZI2C_1_ONE_ADDRESS == EZI2C_1_ADDRESSES) ? (1u) : (0u))

#define EZI2C_1_DEFAULT_PSELECT    ((EZI2C_1_ANY  != EZI2C_1_BUS_PORT) ? (1u) : (0u))
#define EZI2C_1_DEFAULT_SIO_SELECT ((EZI2C_1_I2C1 == EZI2C_1_BUS_PORT) ? (1u) : (0u))
#define EZI2C_1_DEFUALT_CLK_RATE   ((EZI2C_1_DATA_RATE <= EZI2C_1_OVS_32_LIM) ? (1u) : (0u))

/* Return bits within registers position */
#define EZI2C_1_GET_XCFG_HDWR_ADDR_EN(hwAddr) ((0u != (hwAddr)) ? (EZI2C_1_XCFG_HDWR_ADDR_EN) : (0u))
#define EZI2C_1_GET_XCFG_I2C_ON(wakeup)       ((0u != (wakeup)) ? (EZI2C_1_XCFG_I2C_ON) : (0u))

#define EZI2C_1_GET_CFG_PSELECT(pSel)      ((0u != (pSel)) ? (EZI2C_1_CFG_PSELECT) : (0u))
#define EZI2C_1_GET_CFG_SIO_SELECT(sioSel) ((0u != (sioSel)) ? (EZI2C_1_CFG_SIO_SELECT) : (0u))
#define EZI2C_1_GET_CFG_CLK_RATE(clkRate)  ((0u != (clkRate)) ? (EZI2C_1_CFG_CLK_RATE) : (0u))

/* Initial registers settings */
#define EZI2C_1_DEFAULT_CFG    (EZI2C_1_GET_CFG_SIO_SELECT (EZI2C_1_DEFAULT_SIO_SELECT) | \
                                         EZI2C_1_GET_CFG_PSELECT(EZI2C_1_DEFAULT_PSELECT)        | \
                                         EZI2C_1_GET_CFG_CLK_RATE(EZI2C_1_DEFUALT_CLK_RATE)      | \
                                         EZI2C_1_CFG_EN_SLAVE)

#define EZI2C_1_DEFAULT_XCFG   (EZI2C_1_GET_XCFG_HDWR_ADDR_EN(EZI2C_1_DEFAULT_HDWR_ADDR) | \
                                         EZI2C_1_GET_XCFG_I2C_ON(EZI2C_1_ENABLE_WAKEUP)           | \
                                         EZI2C_1_XCFG_CLK_EN)

#define EZI2C_1_DEFAULT_ADDR   (EZI2C_1_DEFAULT_ADDR1)

/* Divide factor calculation */
#define EZI2C_1_DIVIDE_FACTOR_WITH_FRACT_BYTE \
    (((uint32) BCLK__BUS_CLK__KHZ << 8u) / ((uint32) EZI2C_1_DATA_RATE * EZI2C_1_OVERSAMPLE_RATE))

#define EZI2C_1_DEFAULT_DIVIDE_FACTOR  (((uint32) EZI2C_1_DIVIDE_FACTOR_WITH_FRACT_BYTE) >> 8u)

#define EZI2C_1_DEFAULT_CLKDIV1    LO8(EZI2C_1_DEFAULT_DIVIDE_FACTOR)
#define EZI2C_1_DEFAULT_CLKDIV2    HI8(EZI2C_1_DEFAULT_DIVIDE_FACTOR)
...
#define EZI2C_1_BUS_SPEED          EZI2C_1_DATA_RATE
#define EZI2C_1_OVER_SAMPLE_RATE   EZI2C_1_OVERSAMPLE_RATE

#define EZI2C_1_I2C_MASTER_MASK    (0xDDu)

#define EZI2C_1__ANY    EZI2C_1_ANY
#define EZI2C_1__I2C0   EZI2C_1_I2C0
#define EZI2C_1__I2C1   EZI2C_1_I2C1

#define EZI2C_1_DIVIDE_FACTOR  EZI2C_1_DEFAULT_DIVIDE_FACTOR

#if (EZI2C_1_ONE_ADDRESS == EZI2C_1_ADDRESSES)
    void EZI2C_1_SlaveSetSleepMode(void)   ;
    void EZI2C_1_SlaveSetWakeMode(void)    ;
#endif /* (EZI2C_1_ONE_ADDRESS == EZI2C_1_ADDRESSES) */
...
#if (EZI2C_1_TWO_ADDRESSES == EZI2C_1_ADDRESSES)
...
#endif /* (EZI2C_1_TWO_ADDRESSES == EZI2C_1_ADDRESSES) */
