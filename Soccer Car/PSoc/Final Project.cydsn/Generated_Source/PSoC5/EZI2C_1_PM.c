...
{
    EZI2C_1_DISABLED,
    EZI2C_1_DEFAULT_XCFG,
    EZI2C_1_DEFAULT_ADDR,
    EZI2C_1_DEFAULT_CFG,
    EZI2C_1_DEFAULT_CLKDIV1,
    EZI2C_1_DEFAULT_CLKDIV2
};
...
*  EZI2C_1_Sleep() may produce unexpected behavior.
*
*******************************************************************************/
void EZI2C_1_RestoreConfig(void) 
{
    ...
    if (0u != EZI2C_1_wakeupSource)
    {
        ...
        (void) CyIntSetPending(EZI2C_1_ISR_NUMBER);
    }
    EZI2C_1_EnableInt();
#endif /* (EZI2C_1_WAKEUP_ENABLED) */
}
...
{
#if (EZI2C_1_WAKEUP_ENABLED)
    /* Do not re-enable component in EZI2C_1_Wakeup(). It remains enabled as it is wakeup source */
    EZI2C_1_backup.enableState = EZI2C_1_DISABLED;
#else
    /* Store component state enabled or disable to restore after wakeup */
    EZI2C_1_backup.enableState = (EZI2C_1_PM_ACT_CFG_REG & EZI2C_1_ACT_PWR_EN);
